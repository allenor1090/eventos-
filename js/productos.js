document.addEventListener("DOMContentLoaded", function(event) {
    ...
    listadoProductos.forEach(element => {
        divProductos.innerHTML = divProductos.innerHTML + '<div class="card"><div class="card-body"><h5 class="card-title">' + element["nombre_producto"] + '</h5><p>' + element["texto_producto"] + '</p></div></div>';
    });
    return false;
});
